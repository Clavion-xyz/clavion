---
title: Error codes
description: Complete reference for all error responses returned by the ISCL Core API.
...
TxIntent body does not match the schema. See the [TxIntent Schema](/reference/txintent-schema) for the full specification.
...
The manifest does not match the SkillManifest schema. See the [TxIntent Schema](/reference/txintent-schema) for the full specification.
...
Check your TxIntent against the [TxIntent Schema](/reference/txintent-schema). Common issues:
...
No RPC endpoint is configured for the target chain. Set the appropriate environment variable. See the [Configuration Reference](/reference/config-reference) for the full configuration reference.
...
- [REST API](/reference/rest-api) -- Endpoint reference with success response examples
- [TxIntent Schema](/reference/txintent-schema) -- TxIntent and SkillManifest schemas
- [Configuration Reference](/reference/config-reference) -- Environment variables and PolicyConfig
