...
import type { ApprovalTokenVerifier } from "@clavion/types";
import type { AuditTraceService } from "@clavion/audit";
import type { SignRequest, SignedTransaction } from "@clavion/types";

export class WalletService {
  constructor(
    private keystore: EncryptedKeystore,
    private approvalTokenManager: ApprovalTokenVerifier,
